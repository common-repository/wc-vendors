...
import { u as K, r as j } from './responsiveObserve.feb6262f.js';
import { aB as P } from './VendorStore.76a5f248.js';
const _ = Symbol('rowContextKey'),
  ...
  ne = L({
    ...
    setup(e, t) {
      ...
      let b;
      const x = K(),
        v = M({ xs: !0, sm: !0, md: !0, lg: !0, xl: !0, xxl: !0 }),
      ...
      J({ gutter: m, supportFlexGap: d, wrap: $(() => e.wrap) });
      const h = $(() =>
          B(
            o.value,
            {
...
const oe = () => ({
  ...
  ae = L({
    ...
    setup(e, t) {
      let { slots: a, attrs: u } = t;
      const { gutter: o, supportFlexGap: s, wrap: G } = U(),
