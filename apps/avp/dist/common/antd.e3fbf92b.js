import { h as X, n as kt, c as p } from './vendor.e5025a5c.js';
function l(t, e) {
  Lt(t) && (t = '100%');
  var r = Pt(t);
  return (
...
function De(t, e) {
  !t && console !== void 0 && console.error('Warning: '.concat(e));
}
function qe(t, e) {
  De(t, '[@ant-design/icons-vue] '.concat(e));
}
function st(t) {
  return (
    typeof t == 'object' &&
...
`,
  lt = !1,
  We = function() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Ne;
    kt(function() {
      lt ||
        (typeof window < 'u' &&
          window.document &&
  ...
  Ue = ['icon', 'primaryColor', 'secondaryColor'];
function Qe(t, e) {
  if (t == null) return {};
  var r = Ge(t, e),
    n,
...
var O = function(e, r) {
  ...
  if (
    ...
    We(),
    qe(st(a), 'icon should be icon definiton, but got '.concat(a)),
    !st(a))
  )
    return null;
  var u = a;
...
O.getTwoToneColors = Ye;
O.setTwoToneColors = Je;
const W = O;
function Xe(t, e) {
  return rr(t) || er(t, e) || tr(t, e) || Ke();
}
function Ke() {
