...
class WCVendors_Admin_Help {
    ...
    public function add_tabs() {
        ...
        if ( ! $screen || ! in_array( $screen->id, wcv_get_screen_ids(), true ) ) {
            return;
        }
            ...
            array(
                ...
                'content' =>
                    ...
                    /* translators: %s: Documentation URL */
                        ...
                        'https://www.wcvendors.com/article-categories/wc-vendors/?utm_source=plugin&utm_medium=help&utm_campaign=settings'
                    ) . '</p>' .
                    '<p>' . sprintf(
                    ...
                    '<p>' . sprintf( /* translators: %s kb link */ __( 'Please follow our <a href="%s">debuggin guide</a> to ensure that you have narrowed down the issue. ', 'wc-vendors' ), 'https://www.wcvendors.com/knowledge-base/how-to-conduct-basic-debugging-on-wc-vendors/?utm_source=plugin&utm_medium=help&utm_campaign=settings' ) .
        ...
        $screen->add_help_tab(
            array(
                ...
                'content' =>
                    ...
                    '<p>' . sprintf( /* translators: %s geting started link */ __( 'If you are new to WC Vendors then we highly recommend that you go through our <a href="%s">getting started guides</a>.', 'wc-vendors' ), 'https://wcvendors.com/article-categories/getting-started/' ) . '</p>',
            )
        );
