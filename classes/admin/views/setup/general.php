...
<form method="post">
    ...
    <p class="store-setup wcv-setup-input">
        ...
        <input type="number" min="0" max="100" step="0.01" id="wcv_vendor_commission_rate" name="wcv_vendor_commission_rate" placeholder="%" value="<?php echo esc_attr( $commission_rate ); ?>"
        />
    </p>
